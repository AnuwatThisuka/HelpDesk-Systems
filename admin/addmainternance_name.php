                ...
                <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
                    ...
                    <nav class="flex flex-col mt-10 px-1">
                        ...
                        <a href="./allmainternance.php"
                            ...
                            <i class="fa-solid fa-wrench px-2 text-lg"></i>รายชื่อพนักงานซ่อม</a>
                ...
                <div class="flex-1 flex flex-col overflow-hidden">
                        ...
                        <div class="flex items-center space-x-4 lg:space-x-0">
                            ...
                            <div>
                                <h1 class="text-2xl text-gray-800 dark:text-white"><i
                                        class="fa-solid fa-user-plus px-2"></i>หน้าเพิ่มรายชื่อพนักงานซ่อม
                                </h1>
                                <p class="text-sm text-gray-800 dark:text-white">
                                    หน้าเพิ่มรายชื่อพนักงานซ่อม
                                </p>
                            </div>
                        </div>
                    ...
                    <main class="overflow-y-scroll py-10">
                        ...
                        <div class=" bg-gray-200 container mx-auto px-4 py-4 ">
                                ...
                                <div class="flex justify-center items-center">
                                    <div class="flex items-center">
                                        <a class="bg-yellow-500 hover:bg-yellow-600 text-sm py-1 px-3 rounded-lg text-white mr-4 cursor-pointer "
                                            type='button' href="./addmainternance_name.php">
                            ...
                            <div class="bg-white">
                                <form name="register" id="register" action="./mainadd.php" method="POST">
                                    <div class=" container mx-auto text-gray-700">
                                        <div class="mx-4 flex justify-between text-gray-700">
                                            <div class=" mt-4">
                                            ...
                                            <div class="mt-4">
                                                <label class="block" for="lastname">รหัสพนักงาน<label>
                                            ...
                                            <div class="w-full text-gray-700">
                                                <label class="block" for="id">ชื่อผู้ใช้งาน<label>
                                                        <input type="text" placeholder="" name="Username" required
                                                            autofocus
                                                            class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600">
                                                        <label class="block text-xs text-red-600"
                                                            for="id">**ใช้สำหรับเข้าสู่ระบบ<label>
                                            </div>
                                        </div>
                                        <div class="m-4 flex">
                                            <div class="w-full">
                                        ...
                                        <div class="m-4 flex">
                                            <div class="w-full">
                                                <label class="block" for="id">ยืนยันรหัสผ่าน<label>
                                                        <input type="password" placeholder="" name="conPassword"
                                                            minlength="8" required autofocus
                                                            class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600">
                                            </div>
                                        </div>
                                        <div class="py-5 flex items-center px-5">
                                            <button
                                                ...
                                                <i class="fa-solid fa-user-plus pr-2 "></i>เพิ่มรายชื่อ
                                            </button>
                                            <button
