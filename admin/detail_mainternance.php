                    ...
                    <main class="overflow-y-scroll py-10">
                        ...
                        <div class="bg-white w-full">
                            ...
                            <?php
                                ...
                                $jobpending = $row[0];
                            ?>
                            <div class="px-4 py-4 text-gray-700 text-sm font-bold">รายละเอียดผู้ใช้งาน :
                                <?php echo "$user_id" ?>
                            </div>
                            <div class=" px-4 py-1">
                                <div class=" flex justify-between pb-4">
                                    <div class="flex flex-col">
                                        <label for="exampleEmail11"
                                            class="text-gray-700 text-sm font-bold">รหัสพนักงาน</label>
                                    ...
                                    <div class="flex flex-col">
                                        <label for="examplePassword11"
                                            class="text-gray-700 text-sm font-bold">ชื่อผู้ใช้</label>
                                    ...
                                    <div class="flex flex-col">
                                        <label for="exampleEmail11"
                                            class="text-gray-700 text-sm font-bold">ชื่อผู้ใช้งาน</label>
                                        <input name="text" id="exampleEmail11" placeholder="-" type="text"
                                            class="text-gray-700 text-sm bg-gray-200 w-48 px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-600"
                                    ...
                                    <div class="flex flex-col">
                                        <label for="examplePassword11"
                                            class="text-gray-700 text-sm  font-bold">นามสุกล</label>
                                        <input name="text" id="examplePassword11" placeholder="-" type="text"
                                            class="text-gray-700 text-sm bg-gray-200 w-48 px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-600"
                                ...
                                <div class="flex pb-4 justify-between">
                                    <div class="flex flex-col">
                                        <label for="examplePassword11"
                                            class="text-gray-700 text-sm  font-bold">แผนก</label>
                                        <input name="text" id="examplePassword11" placeholder="-" type="text"
                                            class="text-gray-700 text-sm bg-gray-200 w-48 px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-600"
                                    ...
                                    <div class="flex flex-col">
                                        <label for="examplePassword11"
                                            class="text-gray-700 text-sm  font-bold">เวลาที่สมัครเข้าใช้งาน</label>
                                        <input name="text" id="examplePassword11" placeholder="-" type="text"
                                            class="text-gray-700 text-sm bg-gray-200 w-48 px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-600"
                                    ...
                                    <div class="flex flex-col">
                                        <label for="examplePassword11"
                                            class="text-gray-700 text-sm  font-bold">จำนวนงานทั้งหมดที่กดรับ</label>
                                        <input name="text" id="examplePassword11" placeholder="-" type="text"
                                            class="text-gray-700 text-sm bg-gray-200 w-48 px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-600"
                                    ...
                                    <div class="flex flex-col">
                                        <label for="examplePassword11"
                                            class="text-gray-700 text-sm  font-bold">ปัญหาแจ้งซ่อมที่ยังไม่ได้แก้ไข</label>
                                        <input name="text" id="examplePassword11" placeholder="-" type="text"
                                            class="text-gray-700 text-sm bg-gray-200 w-48 px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-600"
                            ...
                            <div class="flex flex-col bg-gray-200">
                                ...
                                <div class="flex justify-around items-center">
                                    ...
                                    ?>
                                        ...
                                        var speed_speed = new Chart(ctx, {
                                            type: 'pie',
                                            data: {
                                                labels: ['ดีมาก [<?php echo "$speed3" ?>]',
                                                    'ดี [<?php echo "$speed2" ?>]',
                                                    'พอใช้ [<?php echo "$speed1" ?>]'
                                                ],
                                                datasets: [{
                                                    label: '# of Users',
                                    ...
                                    <!-- chart 2 ความเรียบร้อยในการทำงาน -->
                                    <div
                                        class=" px-6 py-6 bg-white w-5/12 h-auto text-sm text-white rounded-3xl border-gray-700 border-2 m-4">
                                        <div class="pb-4 px-2">
                                            <div class="flex justify-between items-center">
                                    ...
                                    ?>
                                        ...
                                        var per_per = new Chart(ctx, {
                                            type: 'pie',
                                            data: {
                                                labels: ['ดีมาก [<?php echo "$perfect3" ?>]',
                                                    'ดี [<?php echo "$perfect2" ?>]',
                                                    'พอใช้ [<?php echo "$perfect1" ?>]'
                                                ],
                                                datasets: [{
                                                    label: '# of Users',
                                ...
                                <div class="flex justify-around items-center">
                                    ...
                                    <!-- Chart 3 ปฎิสัมพันธ์กับผู้ใช้งาน -->
                                    <div
                                        class=" px-6 py-6 bg-white w-5/12 h-auto text-sm text-white rounded-3xl border-gray-700 border-2 m-4">
                                        <div class="pb-4 px-2">
                                            <div class="flex justify-between items-center">
                                    ...
                                    ?>
                                        ...
                                        var talk_talk = new Chart(ctx, {
                                            type: 'pie',
                                            data: {
                                                labels: ['ดีมาก [<?php echo "$talk3" ?>]',
                                                    'ดี [<?php echo "$talk2" ?>]',
                                                    'พอใช้ [<?php echo "$talk1" ?>]'
                                                ],
                                                datasets: [{
                                                    label: '# of Users',
                                                    data: [<?php echo "$talk3" ?>,
                                    ...
                                    ?>
                                        ...
                                        var guide_guide = new Chart(ctx, {
                                            type: 'pie',
                                            data: {
                                                labels: ['ดีมาก [<?php echo "$guide3" ?>]',
                                                    'ดี [<?php echo "$guide2" ?>]',
                                                    'พอใช้ [<?php echo "$guide1" ?>]'
                                                ],
                                                datasets: [{
                                                    label: '# of Users',
