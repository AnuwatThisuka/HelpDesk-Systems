                        ...
                        <div class="flex items-center space-x-4 lg:space-x-0">
                            ...
                            <div>
                                <h1 class="text-2xl text-gray-800 dark:text-white"><i
                                        class="fa-solid fa-wrench px-2"></i>หน้ารวมการแจ้งซ่อมทั้งหมด
                                </h1>
                                <p class="text-sm text-gray-800 dark:text-white">
                                    หน้ารวมการแจ้งซ่อมทั้งหมด ที่ผู้ใช้ได้แจ้งซ่อมไว้
                                </p>
                            </div>
                        </div>
                        ...
                        <div class=" bg-gray-200 container mx-auto px-4 py-4 ">
                            <div class="bg-white w-full">
                                <h1 class="px-4 py-6 text-gray-700 text-base font-bold"><i
                                        class="fa-solid fa-clipboard-list px-2 text-lg"></i>รวมการแจ้งปัญหาทั้งหมด</h1>
                            </div>
                            <div class="bg-white">
                                <div class=" container mx-auto">
                                    <div class="text-gray-700 text-base flex flex-col">
                                        <?php
                                                ...
                                                echo "<th class=''>รหัสการแจ้งปัญหา</th>";
                                                echo "<th>ห้อง</th>";
                                                echo "<th>สิ่งของ</th>";
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    if ($row["job_status"] == 'waiting') {
                                                        echo "<td>" . "<div class='bg-red-400 text-gray-700 text-sm rounded-md uppercase py-2'>" . $row["job_status"] . "</div>" . "</td>";
                                                    } else if ($row["job_status"] == 'pending') {
                                                        echo "<td>" . "<div class='bg-yellow-400 text-gray-700 text-sm  rounded-md uppercase py-2'>" . $row["job_status"] . "</div>" . "</td>";
                                                    } else {
                                                                ...
                                                                <div class='py-3'>
                                                                    <div tabindex='-1' role='menu' aria-hidden='true' class=''>
                                                                        <form action='detail.php' method='post'>
                                                                            ...
                                                                            <button type='submit' tabindex='0' class='bg-blue-500 text-white text-sm rounded-md px-2 py-2'>ดูรายละเอียด</button>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                           </td>";
                                                ...
                                                echo "<div class='flex flex-col bg-blue-500 py-1'>
                                                        <div class='px-4 flex flex-col text-sm '>
                                                            <p class='uppercase'>ในขณะนี้ยังไม่มีงาน</p>
                                                            <p>แจ้งปัญหาแล้วหรือยัง ?</p>
                                                        </div>
                                                        <div class='px-4 text-sm bg-yellow-500 w-24 rounded-md'>
                                                            <a href='form_ticket.php' class='hover:bg-yellow-500 hover:underline'>แจ้งปัญหา</a>
                                                        </div>
                                                    </div>";
                                                    }
                                            ?>
