                        ...
                        <div class="flex items-center space-x-4 lg:space-x-0">
                            ...
                            <div>
                                <h1 class="text-2xl text-gray-800 dark:text-white"><i
                                        class="fa-solid fa-wrench px-2"></i>หน้าแสดงการแจ้งซ่อมที่ได้รับการแก้ไขแล้ว
                                </h1>
                                <p class="text-sm text-gray-800 dark:text-white">
                                    หน้าแสดงการแจ้งซ่อมต่างๆ ที่ได้รับการแก้ไขจากพนักงานซ่อมแล้ว
                                </p>
                            </div>
                        </div>
                        ...
                        <div class=" bg-gray-200 container mx-auto px-4 py-4 ">
                            <div class="bg-white w-full">
                                <h1 class="px-4 py-6 text-gray-700 text-base font-bold"><i
                                        class="fa-solid fa-circle-check px-2 text-lg"></i>ปัญหาที่ได้รับการแก้ไขแล้ว
                                </h1>
                            </div>
                            <div class="bg-white">
                                <div class=" container mx-auto px-1">
                                    <div class="text-gray-700 text-base flex flex-col">
                                        <?php
                                                ...
                                                echo "<thead>";
                                                echo "<tr align='center' class=' bg-green-700 text-base text-white h-12 py-4'>";
                                                    ...
                                                    echo "<td class='py-3 text-center'>
                                                                <div class='flex item-center justify-center'>
                                                                    <form action='detail.php' method='post'>
                                                                        ...
                                                                        <button  type='submit' tabindex='0' class='text-sm text-white bg-blue-500 hover:bg-blue-600 py-2 px-3 rounded-md'>
                                                                            ดูรายละเอียด
                                                                        </button>
                                                                    </form>
                                                                </div>
