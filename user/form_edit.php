                        ...
                        <div class="flex items-center space-x-4 lg:space-x-0">
                            ...
                            <div>
                                <h1 class="text-2xl text-gray-800 dark:text-white"><i
                                        class="fa-solid fa-circle-exclamation px-2"></i>หน้าแจ้งปัญหา</h1>
                                <p class="text-sm text-gray-800 dark:text-white">
                                    หน้าแจ้งปัญหาต่างๆ ที่ผู้ใช้ต้องการให้ช่างมาแก้ไข
                                </p>
                            </div>
                        </div>
                        ...
                        <form name="frmlogin" method="post" action="./edit.php">
                            <div class=" bg-gray-200 container mx-auto px-4 py-4 ">
                                <div class="bg-white w-full">
                                    <h1 class="px-4 py-6 bg-blue-600 text-white text-base font-bold"><i
                                            class="fa-solid fa-circle-exclamation px-2 text-lg"></i>แจ้งซ่อม</h1>
                                    <div class="p-4 flex items-center justify-between">
                                        <label for="exampleSelect" class="text-gray-700 text-sm font-bold">ห้อง :
                                        </label>
                                        <div class=" w-4/5 flex items-center text-sm ">
                                            ...
                                            rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600">
                                                <option selected value class="text-gray-700">
                                                    <?php echo "$room"; ?>
                                                </option>
                                                <?php
                                    ...
                                    <div class="p-4 flex items-center justify-between ">
                                        <label for="exampleSelect" class="text-gray-700 text-sm font-bold">สิ่งของ :
                                        </label>
                                        <div class=" w-4/5 flex items-center text-sm">
                                    ...
                                    <div class="p-4 flex items-center justify-between">
                                        <label for="exampleEmail" class="text-gray-700 text-sm font-bold">หมายเลขอุปกรณ์
                                            :
                                        </label>
                                        <div class="w-4/5 text-sm">
                                            <input name="serial_num" required id="exampleEmail"
                                                placeholder="หมายเลขอุปกรณ์" type="text" class="text-gray-700 bg-white w-full px-4 py-2 mt-2 border
                                            rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"
                                                value="<?php echo "$serial_num" ?>">
                                        </div>
                                    </div>
                                    <div class="p-4 flex items-center justify-between">
                                        <label for="exampleText" class="text-gray-700 text-sm font-bold">รายละเอียด :
                                        </label>
                                        <div
                                            class="text-gray-700 bg-white mt-2 border
                                            rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 h-24 w-4/5 text-sm">
                                            <textarea name="detail" required id="exampleText"
                                                class="w-full h-full p-2"><?php echo "$detail" ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="py-5 flex items-center px-5">
                                        ...
                                        <button class="bg-blue-500 hover:bg-blue-700 text-white py-2 px-6 rounded-full"
                                            onclick="
                                            history.back()">
                                            ย้อนกลับ
                                        </button>
