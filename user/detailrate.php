                        ...
                        <div class=" bg-gray-200 container mx-auto px-4 py-4 ">
                            <div class="bg-white w-full">
                                <h1 class="px-4 py-6 text-gray-700 text-base font-bold"><i
                                        class="fa-solid fa-rectangle-list px-2 text-lg"></i>การแจ้งซ่อมที่ยังไม่ได้รับการประเมิณ
                                </h1>
                            </div>
                            <div class="bg-white">
                                <div class=" container mx-auto">
                                    <div class="text-gray-700 text-base flex flex-col">
                                        <?php
                                                ...
                                                echo "<thead>";
                                                echo "<tr align='center' class=' bg-blue-500 text-base text-white h-12 py-4 px-4'>";
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td>" . "<div class='bg-green-500 text-gray-700 uppercase text-sm rounded-md py-2'>" . $row["job_status"] . "</div>" . "</td>";
                                                ...
                                                mysqli_free_result($result);
                                                    ...
                                                    echo "<div class='px-4 flex flex-col text-sm bg-red-500 py-1'>
                                                    <p class='uppercase'>ขณะนี้ยังไม่มีรายการประเมิณ</p>
