                        ...
                        <div class="flex items-center space-x-4 lg:space-x-0">
                            ...
                            <div>
                                <h1 class="text-2xl text-gray-800 dark:text-white"><i
                                        class="fa-solid fa-wrench px-2"></i>รายละเอียดการแจ้งซ่อม
                                </h1>
                                <p class="text-sm text-gray-800 dark:text-white">
                                    หน้ารายละเอียดจะแสดงข้อมูลต่างๆ
                                    ที่ผู้ใช้แจ้งซ่อมเอาไว้
                                </p>
                            </div>
                        </div>
                    ...
                    <main class="overflow-y-scroll py-10">
                        ...
                        <div class=" bg-gray-200 container mx-auto px-4 py-4 ">
                            <div class="bg-white w-full">
                                <h1 class="px-4 py-6 text-white text-base bg-blue-500 font-bold">
                                    <i class="fa-solid fa-circle-exclamation px-2 text-lg"></i>รายละเอียดการแจ้งซ่อม
                                </h1>
                            </div>
                            <div class="bg-white w-full">
                                <?php
                                ...
                                <div class=" px-4 py-1">
                                    <div class=" flex justify-between pb-4">
                                        ...
                                        <div class="flex flex-col">
                                            <label for="examplePassword11"
                                                class="text-gray-700 text-sm font-bold">ห้อง/อาคาร</label>
                                            <input name="text" id="examplePassword11" placeholder="-" type="text"
                                                class="text-gray-700 text-sm bg-gray-200 w-48 px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-600"
                                                value="<?php echo "$room" ?>" disabled>
                                        </div>
                                        <div class="flex flex-col">
                                            <label for="exampleEmail11"
                                                class="text-gray-700 text-sm font-bold">สิ่งของ/คุรุภัณฑ์</label>
                                            <input name="text" id="exampleEmail11" placeholder="-" type="text"
                                                class="text-gray-700 text-sm bg-gray-200 w-48 px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-600"
                                        ...
                                        <div class="flex flex-col">
                                            <label for="examplePassword11"
                                                class="text-gray-700 text-sm  font-bold">รหัสประจำ
                                                สิ่งของ/คุรุภัณฑ์</label>
                                            <input name="text" id="examplePassword11" placeholder="-" type="text"
                                                class="text-gray-700 text-sm bg-gray-200 w-48 px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-600"
                                                value="<?php echo "$serial_num" ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="w-full">
                                        <div class="flex flex-col">
                                            <label for="exampleAddress"
                                                class="text-gray-700 text-sm font-bold">รายละเอียด</label>
                                            <input name="address" id="exampleAddress" placeholder="-" type="textarea"
                                                class="w-full text-gray-700 text-sm bg-gray-200 px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-600"
                                                value="<?php echo "$detail" ?>" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="py-4">
                                        <button
                                            class="bg-green-500 text-base hover:bg-green-700 text-white py-2 px-8 rounded-full"
                                            onclick="
                                            history.back()">
                                            ย้อนกลับ
                                        </button>
