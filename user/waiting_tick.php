                        ...
                        <div class="flex items-center space-x-4 lg:space-x-0">
                            ...
                            <div>
                                <h1 class="text-2xl text-gray-800 dark:text-white"><i
                                        class="fa-solid fa-wrench px-2"></i>หน้าแสดงการแจ้งปัญหาที่อยู่ในระหว่างดำเนินการ
                                </h1>
                                <p class="text-sm text-gray-800 dark:text-white">
                                    หน้าแสดงการแจ้งซ่อมต่างๆ ที่ปัญหาอยู่ในระหว่างดำเนินการ
                                </p>
                            </div>
                        </div>
                        ...
                        <div class=" bg-gray-200 container mx-auto px-4 py-4 ">
                            <div class="bg-white w-full">
                                <h1 class="px-4 py-6 text-gray-700 text-base font-bold"><i
                                        class="fa-solid fa-wrench px-2 text-lg"></i>ปัญหาที่อยู่ระหว่างดำเนินการ</h1>
                            </div>
                            <div class="bg-white ">
                                <div class=" container mx-auto px-1">
                                    <div class="text-gray-700 text-base flex flex-col">
                                        <?php
                                                ...
                                                echo "<thead>";
                                                echo "<tr align='center' class=' uppercase bg-blue-600 text-white h-12 py-4 px-4'>";
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td>" . "<div class='bg-yellow-400 text-gray-700 uppercase rounded-xl py-2'>" . $row["job_status"] . "</div>" . "</td>";
                                                    echo "<td class='py-3 text-center'>
                                                                <div class='flex item-center justify-center'>
                                                                    <form action='detail.php' method='post'>
                                                                        <input type='hidden' name='id' value='" . $row['id'] . "'>
                                                                        <button  type='submit' tabindex='0' class='text-sm text-white bg-green-500 hover:bg-green-600 py-2 px-3 rounded-xl'>
                                                                            ดูรายละเอียด
                                                                        </button>
                                                                    </form>
                                                                </div>
                                        ...
                                        echo "
                                                <div class='px-4 flex flex-col bg-yellow-500 text-sm py-1'>
